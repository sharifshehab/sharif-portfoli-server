...
blogRoutes.post('/blogs', validateRequest(createBlogZodSchema), BlogController.createBlog);  // create user
// blogRoutes.get('/all-users', BlogController.getAllUsers);  // get all users
